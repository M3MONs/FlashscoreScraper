...
class FootballEuropeanHandicapParser(BaseOddsParser):
    sport_type = Sports.FOOTBALL.value
    odds_type = FootballOdds.EUROPEAN_HANDICAP.value
    ODDS_COUNT = 3
    ...
    def _parse_row(self, row: Tag, bookmaker: BookmakerInfo) -> OddsParserRow | None:
        ...
        odds_values = [
            ...
            OddsParserRowData(value=total, type="X", odds=odds_values[1]),
            OddsParserRowData(value=total, type="2", odds=odds_values[2]),
        ]
